...
var project_table = [
    //Project1
    {
        projectName: "Identités Mutuelle",
...
function displayProjects() {
    ...
    // Obtenir tous les éléments d'aperçu de projet
    var projectPreviews = document.querySelectorAll(".project-preview");

    // Boucle à travers les éléments d'aperçu de projet et ajouter un écouteur d'événements "click" pour chacun
    projectPreviews.forEach(function (preview, index) {
        preview.addEventListener("click", function () {
            // Récupérer les images de l'album correspondant au projet cliqué
            var album = paginatedProject[index].album;
            
            if (window.innerWidth >576) {
                // Mettre à jour le contenu de la modale en utilisant les images de l'album
                ...
                // Ajouter un écouteur d'événements "click" pour chaque image de l'album
